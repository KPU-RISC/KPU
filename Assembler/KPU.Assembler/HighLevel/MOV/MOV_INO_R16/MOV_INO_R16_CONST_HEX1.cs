...
namespace KPU_Assembler
{
    public partial class HighLevelAssemblyVisitor<Result>
    {
        ...
        /// <returns></returns>
        public override Result VisitMOV_INO_R16_CONST_HEX1(HighLevelAssemblyParser.MOV_INO_R16_CONST_HEX1Context context)
        {
            ...
            assembly.Add(";; BEGIN MOV [" + destinationRegister + " + " + offset.ToString() + "], 0x" + hexValue + " (MOV_INO_R16_CONST_HEX1)");
            ...
            assembly.Add(";; END MOV [" + destinationRegister + " + " + offset.ToString() + "], 0x" + hexValue + " (MOV_INO_R16_CONST_HEX1)");

            return base.VisitMOV_INO_R16_CONST_HEX1(context);
        }
    }
}
