...
namespace KPU_Assembler
{
    public partial class HighLevelAssemblyVisitor<Result>
    {
        ...
        /// <returns></returns>
        public override Result VisitMOV_INRO_R16_CONST_HEX1(HighLevelAssemblyParser.MOV_INRO_R16_CONST_HEX1Context context)
        {
            ...
            assembly.Add(";; BEGIN MOV [" + destinationRegister + " - " + offsetRegister + "], 0x" + hexValue + " (MOV_INRO_R16_CONST_HEX1)");
            ...
            assembly.Add(";; END MOV [" + destinationRegister + " - " + offsetRegister + "], 0x" + hexValue + " (MOV_INRO_R16_CONST_HEX1)");

            return base.VisitMOV_INRO_R16_CONST_HEX1(context);
        }
    }
}
