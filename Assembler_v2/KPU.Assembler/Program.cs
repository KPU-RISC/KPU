...
using KPU_Assembler;
using KPU.Assembler.Implementation;

namespace KPU.Assembler
{
    class Program
    {
        // private static string rootFolder = @"c:\Github\KPU\Assembler\";
        private static string rootFolder = "/Users/klausaschenbrenner/Documents/KPU/Assembler/";
		private static string outputFolder = rootFolder + @"Output/";

        static void Main(string[] args)
        {
            Console.WriteLine("Hello World from the KPU Assembler!");
		...
		{
            using (System.IO.StreamReader inputFile = new System.IO.StreamReader(new FileStream(outputFolder + "BinaryCode.bin", FileMode.Open)))
			{
				List<string> programLines = ReadProgram(inputFile);

                using (System.IO.StreamWriter outputFile = new System.IO.StreamWriter(new FileStream(outputFolder + "Arduino.c", FileMode.OpenOrCreate)))
				{
		...
		{
            using (System.IO.StreamReader file = new System.IO.StreamReader(new FileStream(outputFolder + "OutputData.bin", FileMode.Open)))
			{
                ...
                using (System.IO.StreamWriter outputFile = new System.IO.StreamWriter(new FileStream(outputFolder + "OutputData.txt", FileMode.Open)))
				{
		...
		{
            using (System.IO.StreamReader file = new System.IO.StreamReader(new FileStream(outputFolder + "BinaryCode.bin", FileMode.Open)))
			{
				List<string> programLines = ReadProgram(file);
				List<string> functionNames = FindFunctionNames(programLines);

                using (System.IO.StreamWriter fileMap = new System.IO.StreamWriter(new FileStream(outputFolder + "BinaryCode.map", FileMode.OpenOrCreate)))
				{
		...
		{
            using (System.IO.StreamReader file = new System.IO.StreamReader(new FileStream(InputFile, FileMode.Open)))
			{
				List<string> programLines = ReadProgram(file);
				List<string> includeFiles = FindIncludeFiles(programLines);
				List<string> dataEntries = new List<string>();

                using (System.IO.StreamWriter filePreProcessor = new System.IO.StreamWriter(new FileStream(outputFolder + "PreProcessor.asm", FileMode.Create)))
				{
					...
					foreach (string inc in includeFiles)
					{
						try
						{
                            ...
                            using (System.IO.StreamReader includeFileReader = new System.IO.StreamReader(new FileStream(rootFolder + @"AssemblyCode\" + inc, FileMode.Open)))
							{
		...
		{
            using (StreamReader preProcesserReader = new StreamReader(new FileStream(outputFolder + "PreProcessor.asm", FileMode.Open)))
			{
                ...
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(new FileStream(outputFolder + "Assembly_LowLevel.asm", FileMode.OpenOrCreate)))
				{
		...
		{
            using (StreamReader lowLevelAssemblyReader = new StreamReader(new FileStream(outputFolder + "Assembly_LowLevel.asm", FileMode.Open)))
			{
                ...
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(new FileStream(outputFolder + "BinaryCode_1stPass.bin", FileMode.OpenOrCreate)))
				{
					int i = 0;
            ...
            using (System.IO.StreamReader file = new System.IO.StreamReader(new FileStream(outputFolder + "BinaryCode_1stPass.bin", FileMode.Open)))
			{
				List<string> programLines = ReadProgram(file);
                ...
                using (System.IO.StreamWriter finalFile = new System.IO.StreamWriter(new FileStream(outputFolder + "BinaryCode.bin", FileMode.OpenOrCreate)))
				{
					foreach (string line in programLines)
					{
