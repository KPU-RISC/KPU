...
namespace KPU_Assembler
{
    public partial class HighLevelAssemblyVisitor<Result>
    {
        ...
        /// <returns></returns>
        public override Result VisitPUSH_CONST_HEX2(HighLevelAssemblyParser.PUSH_CONST_HEX2Context context)
        {
            string hexValue = context.HexValue().GetText();
            string binaryValue = HexToBinary(hexValue);

            // 1. Set the register "XL" to "11111111"
            assembly.Add(";; BEGIN PUSH " + hexValue + "h (PUSH_CONST_HEX2)");
            ...
            assembly.Add(";; END PUSH " + hexValue + "h (PUSH_CONST_HEX2)");

            return base.VisitPUSH_CONST_HEX2(context);
        }
    }
}
