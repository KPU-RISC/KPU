...
namespace KPU_Assembler
{
    public partial class HighLevelAssemblyVisitor<Result>
    {
        ...
        /// <returns></returns>
        public override Result VisitJNZ(HighLevelAssemblyParser.JNZContext context)
        {
            string jumpLabel = context.JumpLabel().GetText();

            // Save the flags register
            assembly.Add(";; BEGIN JNZ " + jumpLabel);
            ...
            // JZ "DestinationLabel"
            assembly.Add("JNZ " + jumpLabel);
            assembly.Add(";; END JNZ " + jumpLabel);
