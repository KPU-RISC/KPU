...
namespace KPU_Assembler
{
    public partial class HighLevelAssemblyVisitor<Result>
    {
        ...
        /// <returns></returns>
        public override Result VisitMOV_INO_R16_CONST_HEX2(HighLevelAssemblyParser.MOV_INO_R16_CONST_HEX2Context context)
        {
            ...
            assembly.Add(";; BEGIN MOV [" + destinationRegister + " + " + offset.ToString() + "], " + hexValue + "h (MOV_INO_R16_CONST_HEX2)");
            ...
            assembly.Add(";; END MOV [" + destinationRegister + " + " + offset.ToString() + "], " + hexValue + "h (MOV_INO_R16_CONST_HEX2)");

            return base.VisitMOV_INO_R16_CONST_HEX2(context);
        }
    }
}
